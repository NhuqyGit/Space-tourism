        ...
        <div className="header-container">
            ...
            {/* <div className="navbar" style={{ display: isOpen ? "none" : "block" }}> */}
                <div onClick={handleClick} className="close-icon">
                    <svg height="19" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="Group">
            ...
            <div className="menu-icon" >
                <svg onClick={handleClick} height="21" viewBox="0 0 24 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g id="Group">
